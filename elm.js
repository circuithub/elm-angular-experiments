...
Elm.App.make = function (_elm) {
   ...
   var decodeAction = function (js) {
      return function () {
         var _v0 = A2($Json$Decode.decodeValue,
         $Json$Decode.maybe($Basics.fst($Giffy.angularActions)),
         js);
         switch (_v0.ctor)
         {case "Err":
            return $Basics.always($Maybe.Nothing)($Debug.log("JSON was")($Basics.always(A2($Json$Encode.encode,
              0,
              js))($Debug.log("error decoding action")(_v0._0))));
            case "Ok": return _v0._0;}
         _U.badCase($moduleName,
         "between lines 47 and 53");
      }();
   };
   var actions = Elm.Native.Port.make(_elm).inboundSignal("actions",
   "Json.Encode.Value",
   function (v) {
      return v;
   });
   var spec = Elm.Native.Port.make(_elm).outbound("spec",
   function (v) {
      return v;
   },
   $Basics.snd($Giffy.angularActions));
   ...
   var view$ = F2(function (a,m) {
      return A2($Giffy.view,
      A2($Signal.forwardTo,
      a,
      $Maybe.Just),
      m);
   ...
   function (v) {
      return {topic: v.topic
             ,slides: Elm.Native.List.make(_elm).toArray(v.slides).map(function (v) {
...
Elm.Elmgular = Elm.Elmgular || {};
Elm.Elmgular.Action = Elm.Elmgular.Action || {};
Elm.Elmgular.Action.make = function (_elm) {
   "use strict";
   _elm.Elmgular = _elm.Elmgular || {};
   _elm.Elmgular.Action = _elm.Elmgular.Action || {};
   if (_elm.Elmgular.Action.values)
   return _elm.Elmgular.Action.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Elmgular.Action",
   $Basics = Elm.Basics.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var showArgumentTag = function (t) {
      return function () {
         switch (t.ctor)
         {case "ArgumentTagBool":
            return "ArgumentTagBool";
            case "ArgumentTagFloat":
            return "ArgumentTagFloat";
            case "ArgumentTagInt":
            return "ArgumentTagInt";
            case "ArgumentTagMaybe":
            return A2($Basics._op["++"],
              "ArgumentTagMaybe ",
              showArgumentTag(t._0));
            case "ArgumentTagString":
            return "ArgumentTagString";}
         _U.badCase($moduleName,
         "between lines 116 and 121");
      }();
   };
   var ArgumentTagMaybe = function (a) {
      return {ctor: "ArgumentTagMaybe"
             ,_0: a};
   };
   var ArgumentTagBool = {ctor: "ArgumentTagBool"};
   var ArgumentTagString = {ctor: "ArgumentTagString"};
   var ArgumentTagFloat = {ctor: "ArgumentTagFloat"};
   var ArgumentTagInt = {ctor: "ArgumentTagInt"};
   var maybe = function (a) {
      return {ctor: "_Tuple2"
             ,_0: ArgumentTagMaybe($Basics.fst(a))
             ,_1: $Json$Decode.maybe($Basics.snd(a))};
   };
   var argumentBool = {ctor: "_Tuple2"
                      ,_0: ArgumentTagBool
                      ,_1: $Json$Decode.bool};
   var argumentString = {ctor: "_Tuple2"
                        ,_0: ArgumentTagString
                        ,_1: $Json$Decode.string};
   var argumentFloat = {ctor: "_Tuple2"
                       ,_0: ArgumentTagFloat
                       ,_1: $Json$Decode.$float};
   var argumentInt = {ctor: "_Tuple2"
                     ,_0: ArgumentTagInt
                     ,_1: $Json$Decode.$int};
   var make3 = F5(function (t,
   mk,
   arg1,
   arg2,
   arg3) {
      return function () {
         var a3 = showArgumentTag($Basics.fst(arg3));
         var d3 = $Basics.snd(arg3);
         var a2 = showArgumentTag($Basics.fst(arg2));
         var d2 = $Basics.snd(arg2);
         var a1 = showArgumentTag($Basics.fst(arg1));
         var spec = $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                      ,_0: "tag"
                                                      ,_1: $Json$Encode.string(t)}
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: "args"
                                                      ,_1: $Json$Encode.list(_L.fromArray([$Json$Encode.string(a1)
                                                                                          ,$Json$Encode.string(a2)
                                                                                          ,$Json$Encode.string(a3)]))}]));
         var d1 = $Basics.snd(arg1);
         var decoder = A2($Json$Decode.andThen,
         A2($Json$Decode._op[":="],
         "tag",
         $Json$Decode.string),
         function (s) {
            return _U.eq(t,
            s) ? A2($Json$Decode._op[":="],
            "args",
            A4($Json$Decode.tuple3,
            mk,
            d1,
            d2,
            d3)) : $Json$Decode.fail(A2($Basics._op["++"],
            "unknown tag for Action : ",
            t));
         });
         return {ctor: "_Tuple2"
                ,_0: decoder
   ...
   arg2) {
      return function () {
         ...
         function (s) {
            return _U.eq(s,
            t) ? A2($Json$Decode._op[":="],
            "args",
            A3($Json$Decode.tuple2,
            mk,
            d1,
            d2)) : $Json$Decode.fail(A2($Basics._op["++"],
            "unknown tag for Action : ",
            t));
         });
         return {ctor: "_Tuple2"
   ...
   arg1) {
      return function () {
         ...
         function (s) {
            ...
            mk,
            d1)) : $Json$Decode.fail(A2($Basics._op["++"],
            "unknown tag for Action : ",
            t));
         });
         return {ctor: "_Tuple2"
   ...
   inner) {
      return function () {
         ...
         function (s) {
            return _U.eq(t,
            s) ? A2($Json$Decode.object1,
            wrp,
            A2($Json$Decode._op[":="],
            "inner",
            $Basics.fst(inner))) : $Json$Decode.fail(A2($Basics._op["++"],
            "unknown tag for Action : ",
            t));
         });
         return {ctor: "_Tuple2"
   ...
   var merge = function (acts) {
      return function () {
         var spec = $Json$Encode.list(A2($List.map,
         $Basics.snd,
         acts));
         var decoder = $Json$Decode.oneOf(A2($List.map,
         $Basics.fst,
         acts));
         return {ctor: "_Tuple2"
                ,_0: decoder
   ...
   var make = F2(function (t,v) {
      return function () {
         ...
         function (s) {
            return _U.eq(s,
            t) ? $Json$Decode.succeed(v) : $Json$Decode.fail(A2($Basics._op["++"],
            "unknown tag for Action : ",
            t));
         });
         return {ctor: "_Tuple2"
   ...
   _elm.Elmgular.Action.values = {_op: _op
                                 ,make: make
                                 ,merge: merge
                                 ,wrap: wrap
                                 ,make1: make1
...
Elm.Elmgular = Elm.Elmgular || {};
Elm.Elmgular.Html = Elm.Elmgular.Html || {};
Elm.Elmgular.Html.make = function (_elm) {
   "use strict";
   _elm.Elmgular = _elm.Elmgular || {};
   _elm.Elmgular.Html = _elm.Elmgular.Html || {};
   if (_elm.Elmgular.Html.values)
   return _elm.Elmgular.Html.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Elmgular.Html",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var embed = A2($Html.node,
   "anglm-compile",
   _L.fromArray([]));
   _elm.Elmgular.Html.values = {_op: _op
                               ,embed: embed
                               ,react: react};
   return _elm.Elmgular.Html.values;
};
Elm.Giffy = Elm.Giffy || {};
Elm.Giffy.make = function (_elm) {
   "use strict";
   _elm.Giffy = _elm.Giffy || {};
   if (_elm.Giffy.values)
   return _elm.Giffy.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Basics = Elm.Basics.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Elmgular$Action = Elm.Elmgular.Action.make(_elm),
   $Elmgular$Html = Elm.Elmgular.Html.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   var SetSingle = function (a) {
      return {ctor: "SetSingle"
             ,_0: a};
   };
   ...
   var angularActions = $Elmgular$Action.merge(_L.fromArray([A2($Elmgular$Action.make,
                                                            "RequestMore",
                                                            RequestMore)
                                                            ,A3($Elmgular$Action.make1,
                                                            "NewGif",
                                                            NewGif,
                                                            $Elmgular$Action.maybe($Elmgular$Action.argumentString))
                                                            ,A3($Elmgular$Action.make1,
                                                            "SetSingle",
                                                            SetSingle,
                                                            $Elmgular$Action.argumentBool)]));
         ...
         {case "NewGif":
            return function () {
                 var newSlides = function () {
                    ...
                    {case "_Tuple2":
                       switch (_v3._0.ctor)
                         {case "Just": switch (_v3._1)
                              {case false:
                                 return A2($List._op["::"],
                                   A3(Slide,_v3._0._0,"",false),
                                   model.slides);
                                 case true:
                                 return _L.fromArray([A3(Slide,
                                   _v3._0._0,
                                   "",
                                   false)]);}
                              break;
   ...
   model) {
      ...
      _L.fromArray([A2($Html.h2,
                   ...
                   ,A2($Html.div,
                   _L.fromArray([imgStyle(function (_) {
                      return _.image;
                   }($Maybe.withDefault(A3(Slide,
                   "",
                   "",
                   false))($List.head(model.slides))))]),
                   _L.fromArray([]))
                   ,A2($Html.button,
                   ...
                   ,$Elmgular$Html.embed(_L.fromArray([A3($Html.node,
                   "carousel",
                   _L.fromArray([A2($Html$Attributes.attribute,
                                "interval",
                                "5000")
                   ...
                   _L.fromArray([A2($Html.img,
                                ...
                                _L.fromArray([]))
                                ,A2($Html.div,
                                _L.fromArray([$Html$Attributes.$class("carousel-caption")]),
                                _L.fromArray([A2($Html.h4,
                                             _L.fromArray([]),
                                             _L.fromArray([$Html.text("Slide {{$index}}")]))
                                             ,A2($Html.p,
                                             _L.fromArray([]),
                                             _L.fromArray([$Html.text("{{slide.text}}")]))]))]))]))]))
                   ,$Elmgular$Html.embed(_L.fromArray([A2($Html.pre,
                                                      _L.fromArray([]),
                                                      _L.fromArray([$Html.text("{{elmModel.single + \' - \' + elmModel.slides}}")]))
                                                      ,A2($Html.button,
                                                      ...
                                                      ,A2($Elmgular$Html.react,
                                                      "elmModel.single",
                                                      "elmActions.SetSingle")]))]));
   });
   _elm.Giffy.values = {_op: _op
                       ,init: init
                       ,update: update
                       ,view: view
